...
GARBAGE_TOKENS: frozenset[str] = frozenset({
    ...
    "WITHDREW", "WITHDRAWN", "WITHDRAWAL", "ENROLLED", "ENROLLMENT", "ENTRANCE",
    "TRANSFER", "TRANSFERRED", "GRADUATED", "DECEASED",
    "BEGAN", "ENDED", "RETURNED", "PROMOTED", "RETAINED",
    "LOST", "DISEASE", "ILLNESS", "ABSENT", "PRESENT",
    "ATTENDANCE", "ABSENCE", "ABSENCES",
    "PERMITS", "PERMIT", "AUTHORIZATION",
    "BIRTHDAY", "BIRTHPLACE",  # already had BIRTH; explicit compounds
})
